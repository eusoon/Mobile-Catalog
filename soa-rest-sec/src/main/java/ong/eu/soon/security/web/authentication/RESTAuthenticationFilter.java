...
/**
 * Created by IntelliJ IDEA. User: kevinpotgieter Date: 27/04/2012 Time: 11:46
...
public class RESTAuthenticationFilter extends
	...
	public Authentication attemptAuthentication(HttpServletRequest request,
		...
		AbstractAuthenticationToken authRequest = createAuthenticationToken(
				apiKeyValue, new RESTCredentials(requestSaltValue,
						hashedSecureValue));
	...
	private String obtainHashedSecureValue(HttpServletRequest request)
	...
	private String obtainRequestSaltValue(HttpServletRequest request)
			throws UnsupportedEncodingException {

		return decodeParameterValue(request, REQUEST_SALT_PARAMETER_NAME);
	}

	private String obtainAPIKeyValue(HttpServletRequest request)
			throws UnsupportedEncodingException {
