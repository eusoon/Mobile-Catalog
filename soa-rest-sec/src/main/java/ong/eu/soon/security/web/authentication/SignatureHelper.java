...
public class SignatureHelper {
	...
	public static String createSortedUrl(HttpServletRequest request) {
		...
		for (Object key : request.getParameterMap().keySet()) {
			String[] o = request.getParameterMap().get(key);
			headersAndParams.put((String) key, o[0]);
		}

		return createSortedUrl(
				request.getContextPath() + request.getServletPath()
				+ request.getPathInfo(), headersAndParams);

	}

	public static String createSortedUrl(String url1,
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Private Key: "
				+ Base64.encodeBase64URLSafeString(privateKeyEncoded));
		System.out.println("Public Key: "
				+ Base64.encodeBase64URLSafeString(publicKeyEncoded));

	}

	public static byte[] generateRSASHA256Signature(String data,
