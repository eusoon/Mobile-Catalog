...
public class Pair<T1, T2> implements Cloneable, Serializable {
	...
	/**
	 * Factory class for a pair. Useful to reduce generics declaration, as
	...
	public Pair(final T1 first1, final T2 second1) {
		this.first = first1;
		this.second = second1;
	}
	...
	public boolean equals(final Object obj) {
		...
		return new EqualsBuilder().append(first, pair.first)
				.append(second, pair.second).isEquals();
	}
	...
	public void setFirst(final T1 first1) {
		this.first = first1;
	}

	public void setSecond(final T2 second1) {
		this.second = second1;
	}
}
