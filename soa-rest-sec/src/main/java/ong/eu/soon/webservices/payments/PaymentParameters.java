 ...
 */
package ong.eu.soon.webservices.payments;

import java.util.List;


import ong.eu.soon.webservices.model.FieldValueVO;
import ong.eu.soon.webservices.utils.ObjectHelper;
...
public class PaymentParameters extends AbstractPaymentParameters {
	 ...
	 * @see {@link ong.eu.soon.webservices.payments.PaymentResult} (<code>getTransfer().getFromMember().getFields()</code>)
	 */
	 ...
	 * NOTE: This list will be taken into account ONLY for an incoming WS request through an unrestricted WS Client.
	 * @see {@link ong.eu.soon.webservices.payments.PaymentResult} (<code>getTransfer().getMember().getFields()</code>)
	 */
