...
import ong.eu.soon.utils.EntityHelper;
import ong.eu.soon.utils.EntityVO;
...
public abstract class Entity implements Serializable, Cloneable {
	...
	public boolean equals(final Object obj) {
		...
		final Long id = getId();
		final Class<? extends Entity> thisRealClass = EntityHelper
				.getRealClass(this);
		final Class<? extends Entity> otherRealClass = EntityHelper
				.getRealClass((Entity) obj);
		if (id != null
				&& (thisRealClass.isAssignableFrom(otherRealClass) || otherRealClass
						.isAssignableFrom(thisRealClass))) {
	 ...
	 *             When the entity already had an identifier
	 */
	 ...
	 * map
	 */
	protected void appendVariableValues(final Map<String, Object> variables,
			final LocalSettings localSettings) {
		//
	}
	...
	protected Object writeReplace() {
		if (this instanceof EntityReference) {
			return new EntityReference.Resolver(
					(Class<? extends Entity>) getClass().getSuperclass(),
					getId());
		}
		return this;
	}
