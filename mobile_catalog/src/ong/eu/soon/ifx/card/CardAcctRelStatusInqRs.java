...
public class CardAcctRelStatusInqRs extends IFXObject {
	...
	CardAcctRelStatusRec[] cardAcctRelStatusRec;	 //	Aggregate	 Optional Repeating	 Card Accountt Relationship Status Record
	//end-block
