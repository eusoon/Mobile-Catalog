...
import ong.eu.soon.ifx.element.BillerRec;
...
public class BillerInqRs extends IFXObject {
	...
	BillerRec[] billerRec;	 //	Aggregate	 Required Repeating	 Biller Record Aggregate
	//end-block
	...
	public BillerRec[] getBillerRec() {
		return billerRec;
	}
	public void setBillerRec(BillerRec[] billerRec) {
		this.billerRec = billerRec;
	}
