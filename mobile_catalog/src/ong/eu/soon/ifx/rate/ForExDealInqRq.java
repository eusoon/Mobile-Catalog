...
import ong.eu.soon.ifx.element.ForExDealSel;
...
public class ForExDealInqRq extends IFXObject {
	...
	ForExDealSel[] forExDealSel; //Aggregate	Required	Foreign Exchange Deal Status Selection Aggregate
	...
	public ForExDealSel[] getForExDealSel() {
		return forExDealSel;
	}
	public void setForExDealSel(ForExDealSel[] forExDealSel) {
