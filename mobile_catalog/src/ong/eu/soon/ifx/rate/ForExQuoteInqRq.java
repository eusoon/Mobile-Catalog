...
import ong.eu.soon.ifx.element.ForExQuoteSel;
...
public class ForExQuoteInqRq extends IFXObject{
	...
	ForExQuoteSel[] forExQuoteSel; //Aggregate	Required	Foreign Exchange Quote Selection Aggregate
	...
	public ForExQuoteSel[] getForExQuoteSel() {
		return forExQuoteSel;
	}
	public void setForExQuoteSel(ForExQuoteSel[] forExQuoteSel) {
