...
import ong.eu.soon.ifx.element.CompRemitStmtSel;
...
public class CompRemitStmtInqRq extends IFXObject {
	...
	CompRemitStmtSel[] compRemitStmtSel; //Aggregate	Required	Comprehensible Remittance Statement Selection Aggregate
	...
	public CompRemitStmtSel[] getCompRemitStmtSel() {
		return compRemitStmtSel;
	}
	public void setCompRemitStmtSel(CompRemitStmtSel[] compRemitStmtSel) {
		this.compRemitStmtSel = compRemitStmtSel;
	}
