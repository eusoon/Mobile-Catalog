...
import ong.eu.soon.ifx.element.SvcProviderRec;
...
public class SvcProviderInqRs extends IFXObject {
	...
	SvcProviderRec[] svcProviderRec;//Aggregate	Required Repeating Service Provider Record
	...
	public SvcProviderRec[] getSvcProviderRec() {
		return svcProviderRec;
	}
	public void setSvcProviderRec(SvcProviderRec[] svcProviderRec) {
