...
public class PmtBatchStatStatus extends IFXObject {

	PmtBatchStatStatusCode pmtBatchStatStatusCode;	 //	Open Enum	 Required	 PmtBatch Status Status CodeValid values include: Deleted, Valid
	...
	public PmtBatchStatStatusCode getPmtBatchStatStatusCode() {
		return pmtBatchStatStatusCode;
	}
	public void setPmtBatchStatStatusCode(
			PmtBatchStatStatusCode pmtBatchStatStatusCode) {
		this.pmtBatchStatStatusCode = pmtBatchStatStatusCode;
	}
