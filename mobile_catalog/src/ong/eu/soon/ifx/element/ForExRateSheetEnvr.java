...
public class ForExRateSheetEnvr extends IFXObject {
	...
	PartyKeys partyKey; //Aggregate	Optional	Reference to the Party that this object is owned by or authorized by.
	...
	public PartyKeys getPartyKey() {
		return partyKey;
	}
	public void setPartyKey(PartyKeys partyKey) {
