...
public class CardStatus extends IFXObject {
	CardStatusCode cardStatusCode;	 //	Open Enum	 Required	 Card Status CodeValid values include: Deleted, Valid
	...
	CardStatusAction cardStatusAction;	 //	Open Enum	 Optional	 Card Status ActionValid values include: Capture, Decline, Normal, Referral	Default Value: Normal
	StatusReason statusReason;	 //	C-80	 Optional	 Status Reason
	
	public CardStatusCode getCardStatusCode() {
		return cardStatusCode;
	}
	public void setCardStatusCode(CardStatusCode cardStatusCode) {
	...
	public CardStatusAction getCardStatusAction() {
		return cardStatusAction;
	}
	public void setCardStatusAction(CardStatusAction cardStatusAction) {
