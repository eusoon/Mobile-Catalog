...
public class DebitStatus extends IFXObject {
	...
	DebitStatusCode[] debitStatusCode; //Open Enum	Required	Debit Status Code	Valid values include: Authorized, Deleted, Held, Posted, Rejected, Valid
	...
	public DebitStatusCode[] getDebitStatusCode() {
		return debitStatusCode;
	}
	public void setDebitStatusCode(DebitStatusCode[] debitStatusCode) {
