...
import ong.eu.soon.ifx.element.AthRsMsg;
...
public class AthSyncRs extends IFXObject {
	...
	AthRsMsg[] athRsMsg;	 //	Aggregate	 Optional Repeating	 Authorization Response Messages Aggregate
	//end-block
	...
	public AthRsMsg[] getAthRsMsg() {
		return athRsMsg;
	}
	public void setAthRsMsg(AthRsMsg[] athRsMsg) {
		this.athRsMsg = athRsMsg;
	}
