...
public class MobileWebAppShellPhone  extends ResizeComposite implements MobileWebAppShell {
	...
	private static final MobileWebAppShellAppearance APPEARANCE = GWT
	  ...
	  public MobileWebAppShellPhone() {
			this(APPEARANCE,orientationHelper);
		}

		public MobileWebAppShellPhone(MobileWebAppShellAppearance appearance,OrientationHelper orientationHelper) {
