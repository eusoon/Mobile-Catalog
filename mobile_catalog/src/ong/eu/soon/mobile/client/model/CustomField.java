...
public class CustomField extends Entity {
    ...
    public final native CustomFieldType getType() /*-{
        return @ong.eu.soon.mobile.client.model.CustomFieldType::valueOf(Ljava/lang/String;)(this.type);
    }-*/;

    public final native CustomFieldControl getControl() /*-{
        return @ong.eu.soon.mobile.client.model.CustomFieldControl::valueOf(Ljava/lang/String;)(this.control);
    }-*/;
