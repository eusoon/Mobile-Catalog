...
public class ServerError extends JavaScriptObject {
    ...
    public final native ErrorType getError() /*-{
        try {
             return @ong.eu.soon.mobile.client.model.ErrorType::valueOf(Ljava/lang/String;)(this.errorCode);
        } catch(e) {
            return @ong.eu.soon.mobile.client.model.ErrorType::UNKNOWN_ERROR;
        }
    }-*/;
