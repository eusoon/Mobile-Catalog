 ...
 */
package ong.eu.soon.mobile.client.loadgeneraldata;
...
import ong.eu.soon.mobile.client.model.Image;
import ong.eu.soon.mobile.client.services.GeneralService;
...
import ong.eu.soon.mobile.client.utils.ImageHelper;
    ...
    private void getGeneralData() {
        generalService.getGeneralData(new BaseAsyncCallback<GeneralData>() {
            ...
            public void onSuccess(GeneralData generalData) {
                InfoproMobile.get().setGeneralData(generalData);
