...
public interface Resources extends ClientBundle {
    ...
    @Source("icons/svc.png")
    ImageResource svc();
    
    @Source("icons/hdpi/svc.png")
    ImageResource svcHdpi();
    
    @Source("icons/xhdpi/svc.png")
    ImageResource svcXhdpi();
    ...
    ImageResource userSearchXhdpi();
	 ...
	 @Source("icons/otp.png")
    ImageResource otp();
    
    @Source("icons/hdpi/otp.png")
    ImageResource otpHdpi();
    
    @Source("icons/xhdpi/otp.png")
    ImageResource otpXhpdi();
    
    @Source("icons/splash.png")
	ImageResource splash();
    
    @Source("icons/hdpi/splash.png")
	ImageResource splashHdpi();
    
    @Source("icons/xhdpi/splash.png")
