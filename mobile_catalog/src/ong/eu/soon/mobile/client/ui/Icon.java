 ...
 */
package ong.eu.soon.mobile.client.ui;
...
public enum Icon {
    ...
    OTP {
        ...
        protected ImageResource imageResource() {
            switch(ScreenHelper.getScreenDensity()) {
                case HDPI:
                    return Resources.INSTANCE.otpHdpi();
                case XHDPI:
                    return Resources.INSTANCE.otpXhpdi();
                default:
					break;
            }
            return Resources.INSTANCE.otp();
        }
    },
    ...
    SVC {
        ...
        protected ImageResource imageResource() {
            switch(ScreenHelper.getScreenDensity()) {
                case HDPI:
                    return Resources.INSTANCE.svcHdpi();
                case XHDPI:
                    return Resources.INSTANCE.svcXhdpi();
                default:
					break;
            }
            return Resources.INSTANCE.svc();
        }
    },
    SETTINGS {
        @Override
    ...
    SPLASH {
        ...
        protected ImageResource imageResource() {
            switch(ScreenHelper.getScreenDensity()) {
                case HDPI:
                    return Resources.INSTANCE.splashHdpi();
                case XHDPI:
                    return Resources.INSTANCE.splashXhdpi();
                default:
					break;
            }
            return Resources.INSTANCE.splash();
        }      
    },
