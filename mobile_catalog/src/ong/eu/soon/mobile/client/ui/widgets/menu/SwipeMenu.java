...
public class SwipeMenu extends Composite implements HasOpenHandlers<SwipeMenu>,
	...
	private static final SwipeMenuAppearance APPEARANCE = GWT
			.create(SwipeMenuAppearance.class);
	...
	private void handleSwipeStart(SwipeStartEvent event) {
		if (state == STATE.CLOSED
				&& event.getDirection() == DIRECTION.LEFT_TO_RIGHT) {
		...
		if (state == STATE.OPEN
				&& event.getDirection() == DIRECTION.RIGHT_TO_LEFT) {
