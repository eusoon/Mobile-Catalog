 ...
 */
package ong.eu.soon.mobile.client.ui.panels;
...
import ong.eu.soon.mobile.client.ui.widgets.Spinner;
import ong.eu.soon.mobile.client.ui.widgets.ToolbarButton;
import ong.eu.soon.mobile.client.ui.widgets.ToolbarButton.ButtonType;
    ...
    private ClickHandler getSpinnerClickHandler() {
        return new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                InfoproMobile.get().getMainLayout().show(null);
            }
        };        
    }
