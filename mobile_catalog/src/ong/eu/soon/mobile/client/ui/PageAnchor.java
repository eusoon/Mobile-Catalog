...
public enum PageAnchor {
    ...
    FUND_TRANSFER(PageGroup.FUND_TRANSFER),
    ...
    SERVICE_PROVIDER(PageGroup.PROVIDERS),
    SERVICES(PageGroup.SERVICES),
    SWIFT_TRANSFER(PageGroup.SWIFT_TRANSFER),
    TRANSFER_PREVIEW(PageGroup.TRANSFERS), 
    TRANSFERS(PageGroup.TRANSFERS), 
    TRANSFERS_OWN_ACCOUNT(PageGroup.TRANSFERS), 
    TRANSACTION_DETAILS(PageGroup.ACCOUNTS),
    OTP(PageGroup.OTP);
