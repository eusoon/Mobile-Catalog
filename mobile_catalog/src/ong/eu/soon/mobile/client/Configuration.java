...
public class Configuration {   
	...
	public String getKerberosServicePrincipalName() {
		return Storage.get().getItem("service.principal.name");
	}
	public void setKerberosServicePrincipalName(String servicePrincipalName) {
		 Storage.get().setItem("service.principal.name", servicePrincipalName);       
	}

	public String getKerberosOid() {
		return Storage.get().getItem("kerberos.oid");
	}
	public void setKerberosOid(String oid) {
		 Storage.get().setItem("kerberos.oid", oid);       
	}
}
