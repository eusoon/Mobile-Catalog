...
public class XferStatus extends IFXObject {
	protected XferStatus(){	
	}
	public final native  XferStatusCode getXferStatusCode()/*-{
		return $wnd.cleanObject(this.xferStatusCode);
	}-*/;
	public final native  void setXferStatusCode(XferStatusCode xferStatusCode)/*-{
