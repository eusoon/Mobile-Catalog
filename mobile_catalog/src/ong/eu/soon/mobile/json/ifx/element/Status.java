...
public class Status extends IFXObject {
	...
	public final native AdditionalStatus getAdditionalStatus() /*-{
		return $wnd.cleanObject(additionalStatus);
	}-*/;
	public final native void setAdditionalStatus(AdditionalStatus additionalStatus) /*-{
