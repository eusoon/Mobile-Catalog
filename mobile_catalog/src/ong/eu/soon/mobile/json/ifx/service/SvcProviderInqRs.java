...
import ong.eu.soon.mobile.json.ifx.element.SvcProviderRec;

import com.google.gwt.core.client.JsArray;


public class SvcProviderInqRs extends IFXObject {
	protected SvcProviderInqRs(){	
	}
	...
	public final native JsArray<SvcProviderRec> getSvcProviderRec() /*-{
		return $wnd.cleanObject(svcProviderRec);
	}-*/;
	public final native void setSvcProviderRec(JsArray<SvcProviderRec> svcProviderRec) /*-{
		this.svcProviderRec = svcProviderRec;
	}-*/;
}