...
import ong.eu.soon.mobile.json.ifx.element.CardRec;
...
public class CardInqRs extends IFXObject {
	protected CardInqRs(){	
	}
	...
	public final native  JsArray<CardRec> getCardRec()/*-{
		return $wnd.cleanObject(this.cardRec);
	}-*/;
	public final native  void setCardRec(JsArray<CardRec> cardRec)/*-{
