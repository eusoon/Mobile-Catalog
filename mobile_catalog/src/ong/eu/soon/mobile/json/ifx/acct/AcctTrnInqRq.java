...
import ong.eu.soon.mobile.json.ifx.element.AcctTrnSel;
...
public class AcctTrnInqRq extends IFXObject {
	...
	public final native AcctTrnSel getAcctTrnSel() /*-{
		return $wnd.cleanObject(this.acctTrnSel);
	}-*/;
	public final native void setAcctTrnSel(AcctTrnSel acctTrnSel) /*-{
