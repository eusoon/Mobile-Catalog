...
public class CreditStatus extends IFXObject {
	...
	public final native  CreditStatusCode getCreditStatusCode()/*-{
		return $wnd.cleanObject(this.creditStatusCode);
	}-*/;
	public final native  void setCreditStatusCode(CreditStatusCode creditStatusCode)/*-{
	...
	public final native  CreditHeldAmtExpDt getCreditHeldAmtExpDt()/*-{
		return $wnd.cleanObject(this.creditHeldAmtExpDt);
	}-*/;
	public final native  void setCreditHeldAmtExpDt(CreditHeldAmtExpDt creditHeldAmtExpDt)/*-{
