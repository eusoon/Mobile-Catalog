...
public class ForExRateSheetInqRs extends IFXObject{
	protected ForExRateSheetInqRs(){	
	}
	...
	public final native JsArray<ForExRateSheetRec> getForExRateSheetRec() /*-{
		return $wnd.cleanObject(this.forExRateSheetRec);
	}-*/;
	public final native void setForExRateSheetRec(JsArray<ForExRateSheetRec> forExRateSheetRec) /*-{
