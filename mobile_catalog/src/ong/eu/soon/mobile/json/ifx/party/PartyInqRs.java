...
import ong.eu.soon.mobile.json.ifx.element.*;
...
public class PartyInqRs extends IFXObject {
	...
	public final native  JsArray<PartyRec> getPartyRec()/*-{
		return $wnd.cleanObject(this.partyRec);
	}-*/;
	public final native  void setPartyRec(JsArray<PartyRec> partyRec)/*-{
