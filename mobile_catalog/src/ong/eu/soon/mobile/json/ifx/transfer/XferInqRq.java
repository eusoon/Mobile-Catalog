...
import ong.eu.soon.mobile.json.ifx.element.XferSel;
...
public  class XferInqRq extends IFXObject {
	...
	public final native  JsArray<XferSel> getXferSel()/*-{
		return $wnd.cleanObject(this.xferSel);
	}-*/;
	public final native  void setXferSel(JsArray<XferSel> xferSel)/*-{
