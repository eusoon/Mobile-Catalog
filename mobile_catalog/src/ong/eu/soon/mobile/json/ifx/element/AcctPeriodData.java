...
public class AcctPeriodData extends IFXObject {
	...
	protected AcctPeriodData(){	
	}
	
	public final native  AcctAmtType getAcctAmtType()/*-{
		return $wnd.cleanObject(this.acctAmtType);
	}-*/;
	public final native  void setAcctAmtType(AcctAmtType acctAmtType)/*-{
		this.acctAmtType = acctAmtType;
	}-*/;
	public final native  AcctPeriodType getAcctPeriodType()/*-{
		return $wnd.cleanObject(this.acctPeriodType);
	}-*/;
	public final native  void setAcctPeriodType(AcctPeriodType acctPeriodType)/*-{
