...
import ong.eu.soon.mobile.json.ifx.element.StdPayeeRqMsg;

public class StdPayeeRevRq extends IFXObject {
	protected StdPayeeRevRq(){	
	}
	...
	public final native StdPayeeRqMsg getStdPayeeRqMsg() /*-{
		return $wnd.cleanObject(stdPayeeRqMsg);
	}-*/;
	public final native void setStdPayeeRqMsg(StdPayeeRqMsg stdPayeeRqMsg) /*-{
