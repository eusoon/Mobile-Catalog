...
public class ForExQuoteStatus extends IFXObject {
	...
	protected ForExQuoteStatus(){
	}
	
	public final native  ForExQuoteStatusCode getForExQuoteStatusCode()/*-{
		return $wnd.cleanObject(this.forExQuoteStatusCode);
	}-*/;
	public final native  void setForExQuoteStatusCode(ForExQuoteStatusCode forExQuoteStatusCode)/*-{
