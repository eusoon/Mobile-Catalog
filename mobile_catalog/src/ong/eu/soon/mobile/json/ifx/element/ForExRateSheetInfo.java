...
public class ForExRateSheetInfo extends IFXObject {
	...
	public final native  JsArray<ForExRateSheetCurRate> getForExRateSheetCurRate()/*-{
		return $wnd.cleanObject(this.forExRateSheetCurRate);
	}-*/;
	public final native  void setForExRateSheetCurRate(
			JsArray<ForExRateSheetCurRate> forExRateSheetCurRate)/*-{
