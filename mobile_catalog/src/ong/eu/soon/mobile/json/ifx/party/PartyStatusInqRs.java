...
public class PartyStatusInqRs extends IFXObject {
	...
	public final native JsArray<PartyStatusRec> getPartyStatusRec() /*-{
		return $wnd.cleanObject(partyStatusRec);
	}-*/;
	public final native void setPartyStatusRec(JsArray<PartyStatusRec> partyStatusRec) /*-{
