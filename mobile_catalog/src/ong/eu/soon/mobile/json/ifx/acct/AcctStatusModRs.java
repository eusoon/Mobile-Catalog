...
public class AcctStatusModRs extends IFXObject {
	...
	public final native JsArray<AcctStatusRec> getAcctStatusRec() /*-{
		return $wnd.cleanObject(this.acctStatusRec);
	}-*/;
	public final native void setAcctStatusRec(JsArray<AcctStatusRec> acctStatusRec) /*-{
