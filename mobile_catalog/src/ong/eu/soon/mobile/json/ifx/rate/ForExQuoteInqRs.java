...
public class ForExQuoteInqRs extends IFXObject {
	...
	public final native JsArray<ForExQuoteRec> getForExQuoteRec() /*-{
		return $wnd.cleanObject(this.forExQuoteRec);
	}-*/;
	public final native void setForExQuoteRec(JsArray<ForExQuoteRec> forExQuoteRec) /*-{
