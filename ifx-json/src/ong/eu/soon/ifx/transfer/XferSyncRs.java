...
public class XferSyncRs extends IFXObject {
	...
	XferRsMsg[] xferRsMsg; //Aggregate	Required Repeating Funds TransferResponse Message Record Aggregate
	...
	public XferRsMsg[] getXferRsMsg() {
		return xferRsMsg;
	}
	public void setXferRsMsg(XferRsMsg[] xferRsMsg) {
