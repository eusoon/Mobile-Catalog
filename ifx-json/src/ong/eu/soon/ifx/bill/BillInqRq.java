...
import ong.eu.soon.ifx.element.BillSel;
...
public class BillInqRq extends IFXObject {
	...
	BillSel billSel[] ;//Aggregate	Required Account Selection Aggregate
	...
	public BillSel[] getBillSel() {
		return billSel;
	}
	public void setBillSel(BillSel[] billSel) {
