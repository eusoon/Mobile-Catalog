...
public class PmtEnclInqRq extends IFXObject {
	...
	PmtEnclSel[] pmtEnclSel;	 //	Aggregate	 Required	 Payment Enclosed Selection Aggregate
	...
	public PmtEnclSel[] getPmtEnclSel() {
		return pmtEnclSel;
	}
	public void setPmtEnclSel(PmtEnclSel[] pmtEnclSel) {
		this.pmtEnclSel = pmtEnclSel;
	}
