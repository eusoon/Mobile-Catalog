...
import ong.eu.soon.ifx.element.PmtBatchStatSel;
import ong.eu.soon.ifx.element.RecCtrlIn;
import ong.eu.soon.ifx.element.RecSelect;
import ong.eu.soon.ifx.element.RqUID;

public class PmtBatchStatInqRq extends IFXObject {
	...
	PmtBatchStatSel[] pmtBatchStatSel;	 //	Aggregate	 Required	 PmtBatch Status Selection Aggregate
	...
	public PmtBatchStatSel[] getPmtBatchStatSel() {
		return pmtBatchStatSel;
	}
	public void setPmtBatchStatSel(PmtBatchStatSel[] pmtBatchStatSel) {
		this.pmtBatchStatSel = pmtBatchStatSel;
	}
