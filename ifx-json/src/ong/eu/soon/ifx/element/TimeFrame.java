...
public class TimeFrame extends IFXObject {
	...
	//end-xor
	AllDayEvent allDayEvent;//Boolean		Optional	All Day Event
	RecurRule[] recurRule;//Aggregate		Optional Repeating	Defines a rule for events that recur in a specific defined pattern.
	RecurException[] recurException;//Aggregate		Optional Repeating	Indicates an exception to the recurrence rule.
