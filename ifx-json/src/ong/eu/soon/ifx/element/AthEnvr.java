...
public class AthEnvr extends IFXObject {
	...
	//begin Aggregate
	AcctStatusCode acctStatusCode;	 //	Open Enum	 Optional	 Account Status CodeValid values include: Abandoned, Active, ChargedOff, ChargeOffInProcess, Closed, Closing, Delinquent, Dormant, Escheat, Frozen, Funded, Inactive, NotAvail, NotFunded, Open, PaidOff, Terminated, Unreedemed
	CardStatusCode cardStatusCode;	 //	Open Enum	 Optional	 Card Status CodeValid values include: Deleted, Valid
