...
public class RemitStatus extends IFXObject {
	RemitStatusCode remitStatusCode;	 //	Open Enum	 Required	 Remit Status Code	Valid values include: Deleted, DelPend, Pending, Posted, Refused, Rejected, Returned, Valid
	...
	public RemitStatusCode getRemitStatusCode() {
		return remitStatusCode;
	}
	public void setRemitStatusCode(RemitStatusCode remitStatusCode) {
