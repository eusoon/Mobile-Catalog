...
public class SecTokenCard extends SecToken {
	...
	Brand brand;//Open Enum	Optional Card Brand Valid values include: AmEx, CarteBancaire, Discover, JCB, MasterCard, PrivateLabel, VISA
	CardTechnology cardTechnology;//Open Enum	Optional Card Technology Valid values include: ICCCard, MagStripeCard
	...
	PINData PINData ; //Aggregate	Optional PIN Data
