...
public class IssuedIdent extends IFXObject {
	...
	USA.TaxIdCert taxIdCert;//Aggregate	Optional USA Tax Identification Certification
	...
	public USA.TaxIdCert getTaxIdCert() {
		return taxIdCert;
	}
	public void setTaxIdCert(USA.TaxIdCert taxIdCert) {
