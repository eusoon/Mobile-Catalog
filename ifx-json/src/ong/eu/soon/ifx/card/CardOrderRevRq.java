...
public class CardOrderRevRq extends IFXObject {
	...
	CardOrderRqMsg cardOrderRqMsg;	 //	Aggregate	 Required	 Card Order Request Messages Aggregate
	...
	public CardOrderRqMsg getCardOrderRqMsg() {
		return cardOrderRqMsg;
	}
	public void setCardOrderRqMsg(CardOrderRqMsg cardOrderRqMsg) {
		this.cardOrderRqMsg = cardOrderRqMsg;
	}
