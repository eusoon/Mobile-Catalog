...
import ong.eu.soon.ifx.element.RemitSel;
import ong.eu.soon.ifx.element.RqUID;

public class RemitInqRq extends IFXObject {
	...
	RemitSel[] remitSel; //Aggregate	Required	Remittance Selection Aggregate
	...
	public RemitSel[] getRemitSel() {
		return remitSel;
	}
	public void setRemitSel(RemitSel[] remitSel) {
		this.remitSel = remitSel;
	}
