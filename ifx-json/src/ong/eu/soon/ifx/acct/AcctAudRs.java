...
import ong.eu.soon.ifx.element.AcctRsMsg;
...
public class AcctAudRs extends IFXObject {
	...
	AcctRsMsg[] acctRsMsg; //Aggregate	Required Repeating Account Response Messages Aggregate
	//end-block
	...
	public AcctRsMsg[] getAcctRsMsg() {
		return acctRsMsg;
	}
	public void setAcctRsMsg(AcctRsMsg[] acctRsMsg) {
