...
public class PassbkItemAudRs extends IFXObject{
	...
	PassbkItemRsMsg[] passbkRsMsg; //Aggregate	Optional Repeating	Passbook ItemResponse Message Record Aggregate
	//end-block
	...
	public PassbkItemRsMsg[] getPassbkRsMsg() {
		return passbkRsMsg;
	}
	public void setPassbkRsMsg(PassbkItemRsMsg[] passbkRsMsg) {
		this.passbkRsMsg = passbkRsMsg;
	}
