...
import ong.eu.soon.ifx.element.PassbkRsMsg;
import ong.eu.soon.ifx.element.RecCtrlOut;
import ong.eu.soon.ifx.element.RqUID;
import ong.eu.soon.ifx.element.Status;

public class PassbkSyncRs extends IFXObject {
	...
	PassbkRsMsg[] passbkRsMsg;	 //	Aggregate	 Optional Repeating	 PassbookResponse Message Record Aggregate
	//end-block
	//end Aggregate
	...
	public PassbkRsMsg[] getPassbkRsMsg() {
		return passbkRsMsg;
	}
	public void setPassbkRsMsg(PassbkRsMsg[] passbkRsMsg) {
