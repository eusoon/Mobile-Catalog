package ong.eu.soon.rest.common.security;
...
public final class SpringSecurityUtil {
	...
	static String nameOfCurrentStore;
	...
	public static String getNameOfCurrentStore() {
		return nameOfCurrentStore;
	}

	public static void setNameOfCurrentStore(final String nameOfCurrentStore1) {
		SpringSecurityUtil.nameOfCurrentStore = nameOfCurrentStore1;
	}
